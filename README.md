...
* **Unity/Linux/Mac** - `Helpers.GetMachineCode()` is not supported at the moment. You need to use the packages in the "Without System.Management" folder on the release page. 
