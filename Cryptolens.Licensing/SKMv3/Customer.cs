...
{
    /// <summary>
    /// Methods that perform operations on a customer object. A complete list can be found here: https://serialkeymanager.com/docs/api/v3/Customer
    /// </summary>
    public class CustomerMethods
    {
        ...
        /// </summary>
        /// <param name="token">An access token with AddCustomer permission. More info: https://serialkeymanager.com/docs/api/v3/Auth</param>
        ...
        /// </summary>
        /// <param name="token">An access token with RemoveCustomer permission. More info: https://serialkeymanager.com/docs/api/v3/Auth</param>
        /// <param name="parameters">Parameters of the method.</param>
        /// <returns></returns>
        ...
        /// </summary>
        /// <param name="token">An access token with GetCustomerLicenses permission. More info: https://serialkeymanager.com/docs/api/v3/Auth</param>
        /// <param name="parameters">Parameters of the method.</param>
        /// <returns></returns>
